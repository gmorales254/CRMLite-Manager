...
(function (e) {
    ...
    e(document).mouseup(function () {
        ...
        function () {
            ...
            drag: function (t, i, s) {
                ...
                })), s.snapElements[c].snapping = !1) : ("inner" !== f.snapMode && (n = m >= Math.abs(u - y), a = m >= Math.abs(d - _), o = m >= Math.abs(h - v), r = m >= Math.abs(l - g), n && (i.position.top = s._convertPositionTo("relative", {
    ...
    e.extend(n.prototype, {
        ...
        _generateHTML: function (e) {
            var t, i, s, n, a, o, r, h, l, u, d, c, p, f, m, g, v, _, y, b, x, w, k, T, D, S, M, C, N, A, P, I, H, z, E, F, O, W, j, L = new Date,
